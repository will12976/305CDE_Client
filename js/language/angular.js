    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           *      - `$element` - Current element
           *      - `$attrs` - Current attributes object for the element
           *    - `bindings` â€“ `{object=}` â€“ Define DOM attribute binding to component properties.
           *      Component properties are always bound to the component controller and not to the scope.
           *    - `transclude` â€“ `{boolean=}` â€“ Whether {@link $compile#transclusion transclusion} is enabled.
           *      Enabled by default.
           *    - `isolate` â€“ `{boolean=}` â€“ Whether the new scope is isolated. Isolated by default.
           ...
           *    - `$canActivate` â€“ `{function()=}` â€“ TBD.
           *    - `$routeConfig` â€“ `{object=}` â€“ TBD.
           *
           * @description
